.. TaskBuster documentation master file, created by
   sphinx-quickstart on Tue Jan 12 19:34:36 2016.
...
in the |tasbuster_turorial|. There you can learn, step by step, how 
TaskBuster has been done, and even do it yourself if you want to!!

.. |taskbuster_tutorial| raw:: html

    <a href="http://marinamele.com/tastbuster-django-tutorial"
    targer="_blank">TaskBuster Django Turorial</a>
