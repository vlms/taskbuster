...
Go to virtual environment folder with::
...
Next, install the packages in each environment::
    ...
    $ workon tb_dev
    $ pip install -r requitements/development.txt
    $ workon tb_test
...
The default language for this Project is **English**, and we use internationalization to translate the text into Lithuanian.
...
Go to the terminal, inside the taskbuster_project folder and create the files to translate with::
    ...
    $ python manage.py makemessages -l lt

change the language "lt" for your selected langueage.

Next, go to the locale folder of your language::

    $ cd taskbuster/locale/lt/LC_MESSAGES
...
Once the translation is done, compile your messages with::
    ...
    $ python manage.py compilemessages -l lt
...
- in **test_intenationalization**, update your languages with the translation of title text, here "Welcome to TaskBuster!"
